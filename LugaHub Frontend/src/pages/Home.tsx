    ...
    return (
        <div className={"main-container"}>
            <div className={"main-header"}>
                ...
                <div className={"main-btn_brands"}>
                    <div className={"main-brands-dropdown"}>
                ...
                <div className={"main-btn-cat"}>
                    <div className={"main-categories-dropdown"}>
            ...
            <div className={"main-body"}>
                <div className={"main-dash1"}>
                    ...
                    <div className={"main-product-dash1"}>
                ...
                <div className={"main-dash2"}>
                    ...
                    <div className={"main-product-dash2"}>
            ...
            <div className={"main-footer"}>
                <div className={"main-get-help"}>
                    ...
                    <span>@2023 Gamehub Pvt. Ltd. All Rights Reserved</span>
